    ...
    public class AutoInterfaceGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            foreach( var classNode in syntaxReceiver.CandidateClasses)
            {
                ...
                var attribute = classNode.AttributeLists.Select(a=>a.Attributes.FirstOrDefault(b=>b.Name.ToFullString()=="AutoInterface")).FirstOrDefault(a=>a != null);

                var isPartial = classNode.Modifiers.Any(m=>m.Text == "partial");
                if(isPartial && attribute != null) {
