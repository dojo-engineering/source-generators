...
{
    internal class ApiControllerAction : IHasRouteParameters, IHasHeaderParameters, IHasRequestBody, IHasQueryParameters, IHasAuthorizationPolicies, IHasVersions
    {
